...
Aprender <- read_delim("https://media.githubusercontent.com/media/Agustin-Bulzomi/Projects/main/Programming/Support_Files/Aprender%202017%20-%20Secundaria.csv", "\t", escape_double = FALSE, trim_ws = TRUE)
```
